  ...
  return (
    <div>
      <div className="min-h-screen bg-[#0d0d0d]">
        <main>
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
            <div className="text-center mb-16">
              ...
              <h1 className="font-heading font-bold text-4xl sm:text-5xl mb-5 text-white">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
              <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-package text-volt mx-auto mb-2"
                >
                ...
                <p className="font-heading font-bold text-2xl text-white">20K+</p>
                <p className="text-white/30 text-xs font-body mt-1">Products</p>
              </div>
              <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-users text-volt mx-auto mb-2"
                >
                ...
                <p className="font-heading font-bold text-2xl text-white">50K+</p>
              ...
              <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-star text-volt mx-auto mb-2"
                >
                ...
                <p className="text-white/30 text-xs font-body mt-1">Avg. Rating</p>
              </div>
              <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-truck text-volt mx-auto mb-2"
                >
            ...
            <div className="bg-[#111] border border-white  rounded-3xl p-8 sm:p-10 mb-12">
              <h2 className="font-heading font-bold text-2xl mb-4 text-white">Our Story</h2>
            ...
            <section className="mb-12">
              <h2 className="font-heading font-bold text-2xl mb-6 text-center text-white">
                What We Stand For
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-[#111] border border-white  hover:border-volt/25 rounded-2xl p-6 transition-all duration-200 flex gap-4">
                  <div className="w-10 h-10 bg-volt/10 rounded-xl flex items-center justify-center shrink-0">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-shield-check text-volt"
                    >
                ...
                <div className="bg-[#111] border border-white  hover:border-volt/25 rounded-2xl p-6 transition-all duration-200 flex gap-4">
                  <div className="w-10 h-10 bg-volt/10 rounded-xl flex items-center justify-center shrink-0">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-truck text-volt"
                    >
                      <path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"></path>
                      <path d="M15 18H9"></path>
                      <path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14"></path>
                ...
                <div className="bg-[#111] border border-white  hover:border-volt/25 rounded-2xl p-6 transition-all duration-200 flex gap-4">
                  <div className="w-10 h-10 bg-volt/10 rounded-xl flex items-center justify-center shrink-0">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-heart-handshake text-volt"
                    >
                ...
                <div className="bg-[#111] border border-white  hover:border-volt/25 rounded-2xl p-6 transition-all duration-200 flex gap-4">
                  <div className="w-10 h-10 bg-volt/10 rounded-xl flex items-center justify-center shrink-0">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-star text-volt"
                    >
                      <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
                    </svg>
                  </div>
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                  <div className="w-12 h-12 bg-volt text-ink rounded-2xl flex items-center justify-center font-heading font-bold text-xl mx-auto mb-3">
                    A
                  </div>
                ...
                <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                  <div className="w-12 h-12 bg-blue-500 text-white rounded-2xl flex items-center justify-center font-heading font-bold text-xl mx-auto mb-3">
                    P
                  </div>
                  <p className="font-body font-semibold text-white/80 text-sm">
                    Priya Mehta
                ...
                <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                  <div className="w-12 h-12 bg-purple-500 text-white rounded-2xl flex items-center justify-center font-heading font-bold text-xl mx-auto mb-3">
                    R
                  </div>
                  <p className="font-body font-semibold text-white/80 text-sm">
                    Rohan Verma
                ...
                <div className="bg-[#111] border border-white  rounded-2xl p-5 text-center">
                  <div className="w-12 h-12 bg-rose-500 text-white rounded-2xl flex items-center justify-center font-heading font-bold text-xl mx-auto mb-3">
                    S
                  </div>
                  <p className="font-body font-semibold text-white/80 text-sm">
                    Sneha Kapoor
            ...
            <div className="bg-volt/8 border border-white/20 rounded-3xl p-8 text-center">
        ...
        <footer className="border-t border-white  py-8 text-center mt-20">
